...
@ConditionalOnProperty( // enabled by default
        ...
        matchIfMissing = true)
@Import({
    DemoRequestsAutoConfiguration.class,
    LayerPreviewAutoConfiguration.class,
    ReprojectionConsoleAutoConfiguration.class,
    SrsListAutoConfiguration.class,
    WcsRequestBuilderAutoConfiguration.class,
    WpsRequestBuilderAutoConfiguration.class
})
public class WebDemosAutoConfiguration extends AbstractWebUIAutoConfiguration {
