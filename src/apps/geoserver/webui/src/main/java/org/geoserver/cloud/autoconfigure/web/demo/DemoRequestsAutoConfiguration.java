...
public class DemoRequestsAutoConfiguration extends AbstractWebUIAutoConfiguration {

    static final String CONFIG_PREFIX = WebDemosAutoConfiguration.CONFIG_PREFIX + ".demo-requests";
