...
public class ResourceBrowserAutoConfiguration extends AbstractWebUIAutoConfiguration {

    static final String CONFIG_PREFIX = WebToolsAutoConfiguration.CONFIG_PREFIX + ".resource-browser";
