...
/**
 * Configuration for Graticule extension that provides a data store for graticule lines.
 *
 * <p>This autoconfiguration class enables the Graticule extension WebUI components
 *
 * @since 3.0.0
 */
