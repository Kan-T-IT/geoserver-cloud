...
/**
 * Imports the transpiled configuration from {@code gs-web-wcs}, except for the {@code wcsRequestBuilder} bean, which is
 * transpiled to its own configuration class {@link WPSRequestBuilderConfiguration} to allow disabling it in
