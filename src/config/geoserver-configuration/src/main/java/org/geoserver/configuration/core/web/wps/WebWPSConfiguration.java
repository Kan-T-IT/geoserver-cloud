...
/**
 * Imports the transpiled configuration from {@code gs-web-wps}, except for the {@code wpsRequestBuilder} bean, which is
 * transpiled to its own configuration class {@link WCSRequestBuilderConfiguration} to allow disabling it in
 * {@code WebDemosAutoConfiguration}.
 *
