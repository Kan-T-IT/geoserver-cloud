...
/**
 * Annotation processor for {@link TranspileXmlConfig} that generates Spring {@code @Configuration} classes from XML
 * bean definitions at compile time.
 *
 * <p>This processor serves as the JSR 269 entry point and delegates the actual transpilation work to
 * {@link XmlToJavaTranspiler}. It handles:
 *
 * <ul>
 *   <li>Processing the annotation and extracting configuration parameters
 *   <li>Validating the annotated elements
 *   <li>Coordinating the transpilation process
 *   <li>Error reporting and diagnostics
 * </ul>
 *
 * <p>The separation of concerns allows the transpiler to be tested and used independently of the annotation processing
 * infrastructure.
 *
 * @since 3.0.0
