...
/**
 * Enhanced bean information containing both Spring's processed data, the original XML structure, and bean name
 * resolution metadata.
 *
 ...
 * @since 3.0.0
 */
public final class EnhancedBeanDefinition {
    ...
    private String reconstructXmlFromBeanDefinition() {
        ...
        if (originalName != null && !originalName.isEmpty() && !isAutoGenerated) {
    ...
    /**
     * Sanitize bean name to be a valid Java method identifier. This method is used by all generators to ensure
     * consistent bean name sanitization.
     */
    public static String sanitizeBeanName(String beanName) {
        if (beanName == null || beanName.isEmpty()) {
            return "unknownBean";
        }

        // Replace non-alphanumeric characters with underscores
        String sanitized = beanName.replaceAll("\\W", "_");
    ...
    private static boolean shouldIncludeNameInBeanAnnotation(String originalBeanName, String sanitizedMethodName) {
        ...
        return !originalBeanName.equals(sanitizedMethodName);
    }
