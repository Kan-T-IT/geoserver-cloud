...
/**
 * Enhanced XmlBeanDefinitionReader that provides access to our custom document reader so we can extract the enhanced
 * bean information after parsing.
 *
 * @since 3.0.0
 */
class EnhancedXmlBeanDefinitionReader extends XmlBeanDefinitionReader {
    ...
    /** Get access to the enhanced document reader that captured the XML and BeanDefinition info */
    ...
    /**
     * Extract bean definitions from the factory - only primary bean names, not aliases. Aliases will be handled through
     * BeanNameInfo and included in {@code @Bean(name={...})} arrays
     */
